...
def create_default_prompts():
    return [
        {
            "title": "블로그 글 작성 도우미",
            "content": "당신은 10년 경력의 전문 블로거입니다. 주어진 주제에 대해 서론, 본론, 결론 구조로 SEO 친화적인 글을 작성해주세요.",
            "category": "텍스트 생성",
            "favorite": True,
        },
        {
            "title": "제품 썸네일 이미지 프롬프트",
            "content": "신제품 런칭용 썸네일 이미지를 밝고 깔끔한 톤으로 생성해주세요. 제품이 중앙에 보이게 하고 브랜드 색상을 반영해주세요.",
            "category": "이미지 생성",
            "favorite": False,
        },
        {
            "title": "뉴스 요약 자동화 프롬프트",
            "content": "오늘의 주요 뉴스를 3줄로 요약하고 각 뉴스의 핵심 키워드를 함께 정리해주세요.",
            "category": "자동화",
            "favorite": False,
        },
    ]
