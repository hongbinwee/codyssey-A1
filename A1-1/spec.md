...
- 현재 프로그램 코드: `A1-1/main.py`
- 현재 제출 안내 문서: `README.md`, `submission_checklist.md`, `git_workflow_guide.md`, `handoff.md`
- 루트 작업 규칙: `../AGENTS.md`

## 작업 단계

1. `main.py`를 `A1-1/` 안으로 이동한다.
2. 이동된 구조를 기준으로 실행 명령과 문서 경로를 수정한다.
...
- `cd A1-1 && python3 main.py`
- `cd A1-1 && PYTHONPYCACHEPREFIX=/tmp/codyssey-a1-pycache python3 -m py_compile main.py`
- `rg -n "main.py|python3 main.py|A1-1/" A1-1 AGENTS.md`
- `git status --short`
